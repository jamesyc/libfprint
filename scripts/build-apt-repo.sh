...
mkdir -p \
  ...
  "$site_dir/apt/dists/$suite/$component/binary-$arch" \
  "$site_dir/keys"
...
<body>
  ...
  <pre>deb [arch=amd64 signed-by=/etc/apt/keyrings/libfprint-vfs0090.asc] https://jamesyc.github.io/libfprint/apt trixie main</pre>
</body>
</html>
HTML
